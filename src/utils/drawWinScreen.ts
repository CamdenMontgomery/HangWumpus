...
const IMAGE_PATH = path.join(process.cwd(), "public","images","win.png")
...
/**
 * Draws the "win" screen onto the provided 2D canvas context.
 *
 * The function loads a predefined win background image and renders it to fill
 ...
 */
export default async function drawWinScreen(context: Canvas.SKRSContext2D , answer: string) {
